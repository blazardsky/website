...
const Navbar = ({isHome=false}) => {
  ...
  return (
    <header className="relative p-3 flex align-center justify-center">
        <nav className="min-w-fit w-2/5 py-3 px-8 bg-yellow-500 text-black -skew-x-3">
            <ul role="list" className="list-style-none mx-auto flex flex-row flex-wrap items-center justify-center ">
                {
